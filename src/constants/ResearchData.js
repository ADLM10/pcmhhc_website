    ...
    description: (
      <p>
        <span style={{ display: "flex", justifyContent: "center" }}>
          <img src={require("../assets/Research.jpg")} alt="Research" />
          <br />
        </span>
        <br />
        We are engaged and continuing Drug Proving (Homoeopathic Pathogenetic
        Trail) programme with the given guidenlines in the protocol of Central
        Council for Research in Homoeopathy (CCRH), Government of India from
        2014.
        <br />
        <br />
        ...
        their research ethical before approving them. Research protocols of two
        students Kankona Das and Debayan Khan respectively were approved by the
